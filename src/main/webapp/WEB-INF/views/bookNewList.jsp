   	...
   	<div class="card-body" align="center">
	  	<table width="1000"  border=1   cellspacing="0">
	  	 <tr align="right" height=50>
	  	 	<td colspan="7"> 신규도서 TOP 10 &nbsp;  </td>
	  	 </tr>
  
     <tr>
      <td>번호</td> <td>책</td> <td>제목</td>
      <td>저자</td> <td>출판사</td> <td>장르</td> <td>출간일</td>
     </tr>
     
     <c:forEach var="dto" items="${nw}">
     <tr height=20>
    	<td>  ${dto.rn} </td>
    	<td align="center">
    	...
    	<td>  ${dto.publisher} </td>
    	<td>  ${dto.genre} </td>
    	<td> <fmt:formatDate value="${dto.publisheddate}" pattern="yyyy-MM-dd"/> </td>
